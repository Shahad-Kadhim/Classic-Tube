...
class MovieWatched(context: Context) : BaseHelper(context )  {
    ...
    private fun MoviesWatch() = "CREATE TABLE ${DBConstant.WATCH_TABLE_NAME} ( " +
    ...
    val allMovieSave : Cursor
        get() {
            ...
            val res = db.rawQuery("SELECT * FROM " + DBConstant.WATCH_TABLE_NAME, null)
            return res
        }
